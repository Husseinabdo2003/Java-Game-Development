...
public class TitanRegistry {
    ...
    public Titan spawnTitan(int distanceFromBase) {
        switch (code) {
            case 1:
                return new PureTitan(baseHealth, baseDamage, heightInMeters, distanceFromBase, speed, resourcesValue,
                        dangerLevel);
            ...
            case 3:
                return new ArmoredTitan(baseHealth, baseDamage, heightInMeters, distanceFromBase, speed, resourcesValue,
                        dangerLevel);
